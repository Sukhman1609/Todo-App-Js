...
heading.style.placeItems = "center";
    ...
    if (window.innerWidth <= 768) {
        ...
        // document.getElementsByClassName("todo-container").style.marginTop = "-40px";
        // document.getElementById("addItem1").style.marginLeft = "40px";
        heading.style.position = "absolute";
        heading.style.top = "80px";
        heading.style.right= "80px";
...
backButton.addEventListener("click", function() {
    ...
    document.getElementById("heading").style.display = "inline";
    document.getElementById("list1").style.display = "inline";
    document.getElementById("heading").style.margin = "35px auto auto -460px";
    ...
    document.getElementById("addItem1").style.marginTop = "37px";
    var todoHeading = document.querySelector("#todoHeading");
    var hr = document.querySelector("hr");
